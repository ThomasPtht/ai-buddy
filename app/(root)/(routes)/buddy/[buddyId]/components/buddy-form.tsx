        ...
        <div className="h-full p-4 space-y-2 max-w-3xl mx-auto">
            ...
            text-lg font-medium">
                    ...
                    <div className="space-y-2 w-full">
                        <div>
                            <h3 className="text-ly font-medium">Configuration</h3>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="col-span-2 md:col-span-1">
                                ...
                                <FormDescription>Describe in detail your buddy's backstory and relevant details.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
